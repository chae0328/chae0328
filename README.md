...
* 알고리즘 구성
  * **StyleGAN2 모델과 Face Parsing 모델을 이용한 이미지 합성** <br/><br/> Face Parsing 모델을 이용하여 사용자의 이미지와 합성할 이미지의 segmentation 결합 후 FFHQ 데이터셋으로 사전 학습된 StyleGAN2 모델을 통해 합성된 이미지가 생성될 수 있도록 진행하였습니다.(This project contains code released by [Barbershop](https://github.com/ZPdesu/Barbershop).)
