...
* 알고리즘 구성
  * **Darknet 기반 YOLOv4 모델을 통한 분만 및 난산 징후 탐지** <br/><br/> 소가 일정시간동안 꼬리를 지속적으로 들어올리는 행위는 분만 징후와 매우 밀접하게 관련되있습니다. 목장 CCTV 영상 데이터를 활용하여 꼬리를 들어올리는 영역과 난산을 예방하기 위해 출산이 원할하게 됫는지 판단하고자 출산 데이터도 레이블링을 수행하여 학습을 진행하였습니다.  
