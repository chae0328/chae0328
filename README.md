...
* 알고리즘 구성
  * **Top-Down 방식을 통한 젖소의 골격 키포인트 도출** <br/><br/> YOLOv8을 활용하여 이미지에서 젖소를 탐지 하였습니다. 이후  DeepLabCut모델을 활용하여 개별 젖소를 탐지한 영상은 사각 이미지로 추출(cropping) 하였고 골격 키포인트를 생성하여 자세 추정을 진행하였습니다.
<br/><br/>
